"""
Django settings for bike_sharing_platform project.
...
ALLOWED_HOSTS: list[str] = config("ALLOWED_HOSTS", default=[], cast=list)
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": """
    REST API for the Bike Sharing Platform.
    Authentication: Bearer token.
    """,
    "VERSION": "0.1.0",
    "CONTACT": {
        "name": "API Support",
        "email": "support@bikesharing.com",
    },
    "LICENSE": {
        "name": "GPL-3.0-only",
    },
